...
**0.**  Take a look at the existing [issues](https://github.com/p32929/p32929.github.io/issues) or create your own issues. Wait for the Issue to be assigned to you after which you can start working on it.

**1.**  Fork [this](https://github.com/p32929/p32929.github.io) repository.

**2.**  Clone your forked copy of the project.

```
git clone --depth 1 https://github.com/<your_user_name>p32929.github.io.git
```
...
```
git remote add upstream https://github.com/p32929/p32929.github.io.git
```
